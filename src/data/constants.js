export const Bio = {
  ...
  description:
    "I am a software developer with industry experience of 4 years with ability to develop custom software applications and update existing programs to refine components, committed to building a successful career in software development. Having effective interpersonal skills helps working as part of a team with people at all organizational levels and diverse backgrounds."
  ,
  github: "https://github.com/KariBhanu",
  resume:
    "https://drive.google.com/file/d/1J0MB0UJ4lRQTNy0Ah90KJRgtPotW-FTe/view?usp=drive_link",
  linkedin: "https://www.linkedin.com/in/bhanu-kari-b3831a16b/",
  ...
  },
  {
    ...
    skills: [
      ...
      },
      {
        ...
        image:
          "https://upload.wikimedia.org/wikipedia/commons/c/cb/New-azure-logo-square.png",
      },
      {
        name: "Docker",
        image:
  ...
  // },
  {
    ...
    skills: [
      ...
      },
      {
        name: "GitLab",
        image:
          "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSO7wQiMYD3gQIcIBWtAg9Zdp3OvlQPk2FZfwJWqzh00-v0K_Jy6Z7zpf9NFg2MLzFTkio&usqp=CAU",
      },
      {
        name: "VS Code",
        image:
...
export const projects = [
  {
    ...
    description:
      "An Ecommerce analytics dashboard which helps users to know what are the sales of products and reviews of the user on the products along with extensive graphical and tabular representation of sales according to geographical region, transacation and number of users using the platform",
    image:
      "https://miro.medium.com/v2/resize:fit:1044/1*MlWhIHFkLqGanUyrPa37cg.png",
    tags: [
      "React Js",
      "MongoDB",
      "Node Js",
    ...
    category: "web app",
    github: "https://github.com/rupeshjaiswar/mern-dashboard",
    webapp: "https://dashboard-frontend-5p76.onrender.com/",
  },
  {
    id: 9,
    ...
    description:
      "Used an open source OHIF application for my current organization for visualising the radiology images. OHIF Viewer is an open source, web-based, medical imaging platform. It aims to provide a core framework for building complex imaging applications",
    image:
      "https://i.ytimg.com/vi/DpmF4QZYoH0/maxresdefault.jpg",
    tags: [
      "Docker",
      "GCP",
      "React Js",
